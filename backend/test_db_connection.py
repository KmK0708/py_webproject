...
# 환경 변수에서 연결 정보를 직접 가져오는 것이 가장 좋습니다.
# 여기서는 하드코딩된 값을 사용하여 Supabase Pooler 연결을 보여줍니다.
# 
# **경고: 실제 비밀번호는 코드에 직접 하드코딩하지 마세요. `.env` 파일이나 
# 환경 변수에서 불러와야 합니다.**

DB_HOST = "aws-1-ap-northeast-2.pooler.supabase.com"  # Pooler Host
DB_PORT = 6543                                       # Transaction Pooler Port
DB_NAME = "postgres"
DB_USER = "postgres.fgiqzrqdlqgfngrulbns"
DB_PASSWORD = "rlawndud!23"             # **실제 비밀번호로 교체**
